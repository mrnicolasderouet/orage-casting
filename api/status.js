...
const ALLOWED_FIELDS = ["status", "vimeo", "photo", "archived", "role", "name", "email", "email2", "agency", "agentName", "assistantName", "cv", "showreel", "availability", "note", "displayOrder", "displayGroup", "declineReason", "internalStatus"];
